...
export default function Tab({ tab: { name }, onPress, imageActive }: Props) {
  ...
  return (
    <TouchableOpacity style={styles.container} onPress={onPress}>
      <Image
        source={imageActive ? imageActiveState : imageInactiveState}
        style={styles.image}
        resizeMethod="resize"
        resizeMode="contain"
      />
      <Text style={imageActive ? styles.textActive : styles.textInactive}>{name}</Text>
    </TouchableOpacity>
  );
}
